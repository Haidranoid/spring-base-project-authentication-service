package com.springbaseproject.authenticationservice.controllers.internals;
...
@Slf4j
@Tag(name = "Internal Authentication Controller", description = "Internal endpoints. Do NOT call directly from client applications.")
